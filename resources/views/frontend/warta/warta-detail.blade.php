            ...
            <div class="container">
              ...
              <article class="article rounded-3">
                ...
                <div class="post-img overflow-hidden rounded-top-3">
                  <div class="position-absolute px-3 py-2 text-white " style="background-color:rgba(126, 87, 194, 1); margin-top:20px; border-bottom-right-radius: 10px; border-top-right-radius: 10px;">{{\Carbon\Carbon::parse($warta[0]->created_at)->format('d-m-Y')}} | {{ucfirst($warta[0]->kategori)}}</div>
                  <img src="{{ $warta[0]->gambar !== '/img/no_image.jpg' ? asset('storage/'.$warta[0]->gambar) : asset('storage'.$warta[0]->gambar) }}" alt="" class="img-fluid" style="height:400px; width: 100%; object-fit:cover">
                </div>

                <h2 class="title">{{$warta[0]->judul}}</h2>
                ...
                <div class="meta-bottom">
                    <strong>Bagikan:</strong>
                        <div class="d-flex gap-2 mt-2">
                            ...
                            <a href="https://api.whatsapp.com/send?text={{ urlencode($warta[0]->judul . ' ' . request()->fullUrl()) }}" target="_blank">
        ...
        <div class="col-lg-4 sidebar">
          ...
          <div class="widgets-container rounded-3">
            ...
            <div class="recent-posts-widget widget-item">
              <h3 class="widget-title">Warta Terbaru</h3>

              @foreach($warta[1] as $baru)
                ...
                <div class="post-item overflow-hidden">
                  ...
                  <div>
                    <h4><a href="{{route('warta.detail',$baru->slug)}}">{{substr($baru->judul,0, 50).'...'}}</a></h4>
