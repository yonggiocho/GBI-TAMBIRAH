                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Tambah Data KK</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                      ...
                                      <form method="POST" action="{{route('backend.keluarga.store')}}">
                                        @csrf
                                        <div class="row">
                                          <div class="col-xl-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="kepala_keluarga" name="kepala_keluarga" class="form-control" placeholder="Masukkan nama keluarga" value="{{ old('kepala_keluarga')}}">
