                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Edit Warta</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                      ...
                                      <form method="POST" action="{{route('backend.warta.update', $warta->id)}}" enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
                                        ...
                                        <div class="row">
                                          <div class="col-xl-12">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="judul" name="judul" class="form-control" placeholder="Masukkan judul . . ." value="{{ old('judul', $warta->judul)}}">
                                                      @error('judul')
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="kategori" id="kategori" class="form-select" required>
                                                       ...
                                                       @foreach ($kategori as $k)
                                                        <option value="{{$k}}" {{ old('kategori', $warta->kategori) == $k ? 'selected' : '' }}>{{ucfirst($k)}}</option>
                                                       @endforeach
                                                    </select>
                                                     @error('kategori')
                                                        <small class="form-text text-danger">
                                                ...
                                                <div class="mb-3 overflow-hidden">
                                                    ...
                                                    @if($warta->gambar)
                                                    <img class="gambar-preview img-fluid mb-3 col-sm-5" src="{{asset('storage/'.$warta->gambar)}}" style="width: 250px; display:block;">
                                                    @else
