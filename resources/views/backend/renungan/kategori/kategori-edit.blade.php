                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Edit Kategori Renungan</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                      ...
                                      <form method="POST" action="{{route('backend.kategori.renungan.update',$kategori->id)}}" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                          <div class="col-xl-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="kategori" name="kategori" class="form-control" placeholder="Masukkan judul kategori..." value="{{ old('kategori', $kategori->kategori)}}">
                                                      @error('kategori')
                                                ...
                                                <div class="mb-3 overflow-hidden">
                                                    ...
                                                    <img class="thumbnail-preview img-fluid mb-3 col-sm-5" src="{{asset('storage/'.$kategori->thumbnail)}}" style="width: 250px; display:block;">
                                                    @else
                                                    <img class="thumbnail-preview img-fluid mb-3 col-sm-5" style="height: 150px; width: 250px; ">
                                                    @endif
